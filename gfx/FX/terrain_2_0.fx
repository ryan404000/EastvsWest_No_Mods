...
VS_MAP_OUTPUT VertexShader_Map_General(const VS_INPUT v )
{
	...
	Out.vTerrainIndexColor.x = ((WorldPosition.x - TerrainIndexOffsetX) + 0.5) / TerrainIndexSizeX;
	Out.vTerrainIndexColor.y = ((WorldPosition.z - TerrainIndexOffsetY) + 0.5) / TerrainIndexSizeY;
...
VS_OUTPUT_BEACH VertexShader_Beach_General(const VS_INPUT_BEACH v )
{
	...
	Out.vBorderTexCoord0.xy = float2( WorldPosition.x/vXStretch , WorldPosition.z/vYStretch  );
