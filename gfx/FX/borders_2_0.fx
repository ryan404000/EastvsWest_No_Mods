...
#define WATER_BORDER_TEXTURE_SIZE 1024.0f
#define WATER_BORDER_TILE_WIDTH 50.0f

float4x4 WorldViewProjectionMatrix;

VS_WATEROUTPUT VertexShader_WaterBorder(const VS_WATERINPUT v )
{
	float4 vPosition = float4( v.vPosition.x + 0.5f, WATER_BORDER_ALT, v.vPosition.y + 0.5f, 1 );
	...
	Out.vDiagCoord.x  += v.vUV_Offset.w / 16.0f;
